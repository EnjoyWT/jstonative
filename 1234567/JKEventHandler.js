var JKEventHandler ={
    ...
    callNativeFun:function(nativeMethodName,params,callBackID,callBack){
        var message;
        ...
        if(!callBack){
            ...
            message = {'methodName':nativeMethodName,'params':params,'successCallBackID':callBackID};
    ...
    callNativeFun2:function(nativeMethodName,params,callBackID,successCallBack,failureCallBack){
        var message;
        if(successCallBack && failureCallBack){
            ...
            message = {'type':'callNativeFun2','methodName':nativeMethodName,'params':params,'successCallBackID':successCallBackID,'failureCallBackID':failureCallBackID};
            ...
            var successCallBackID = callBackID;
            successCallBackID +='successCallBack';
            message = {'type':'callNativeFun2','methodName':nativeMethodName,'params':params,'successCallBackID':successCallBackID};
            if(!JKBridgeEvent._listeners[successCallBackID]){
                JKBridgeEvent.addEvent(successCallBackID, function(data){
            ...
            var failureCallBackID = callBackID;
            failureCallBackID +='failureCallBack';
            message = {'type':'callNativeFun2','methodName':nativeMethodName,'params':params,'failureCallBackID':failureCallBackID};
            if(!JKBridgeEvent._listeners[failureCallBackID]){
                JKBridgeEvent.addEvent(failureCallBackID, function(data){
            ...
            message = {'type':'callNativeFun2','methodName':nativeMethodName,'params':params};
            window.webkit.messageHandlers.JKEventHandler.postMessage(message);
        }
    },
