...
- (void)userContentController:(WKUserContentController *)userContentController
   ...
   #pragma clang diagnostic pop
        ...
        NSString *callNativeFun2 = message.body[@"type"];
        NSString *funcName = message.body[@"methodName"];
        NSDictionary *params = message.body[@"params"];
        NSString *successCallBackID = message.body[@"successCallBackID"];
        NSString *failureCallBackID  = nil;
        if (callNativeFun2) {
          failureCallBackID = message.body[@"failureCallBackID"];
        }
